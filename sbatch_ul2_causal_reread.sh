...
#SBATCH --job-name=deepseek-math-ul2-gsm8k-septoken-maskfull-sentence-equation-lossfulltarget-5-ul2-bartmixed-causalprefix-reread
...
JOB_NAME="deepseek-math-ul2-gsm8k-septoken-maskfull-sentence-equation-lossfulltarget-5-ul2-1-bartmixed-causalprefix-reread"
save_dir="saves/${JOB_NAME}"
n_gpus=2
model_path="deepseek-math-7b-base"
datasets="gsm8k_train_5_ul2_reread_1_bartmixed_causalprefix"
ul2_causal=true
