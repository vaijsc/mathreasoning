...
#SBATCH --job-name=qwen2-base-ul-gsm-qwenmath-template-lorahead-bi-nomask
...
JOB_NAME="qwen2-base-ul-gsm-qwenmath-template-lorahead-causalpref-bi-nomask"                                                                           
...
bash LLaMA-Factory/ul2_qwen.sh $model_path $save_dir $n_gpus $datasets $ul2_causal $template   
