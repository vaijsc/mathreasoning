...
from ...data import UL2DataCollatorWith4DAttentionMask, SFTDataCollatorWith4DAttentionMask, get_dataset
...
def run_ul2(
    ...
    if not data_args.ul2_causal:
        data_collator = UL2DataCollatorWith4DAttentionMask(
            tokenizer=tokenizer,
        ...
        print("CAUSAL PREFIX ATTENTION PLS!!")
    ...
    # @QHP: add data args for better finetuning
    ...
    # @QHP: set signature column 
    if not data_args.ul2_causal:
        trainer._signature_columns = ["prefix_lengths", "input_ids", "attention_mask", "labels"]
