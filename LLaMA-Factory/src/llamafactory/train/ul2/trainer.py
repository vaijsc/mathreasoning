...
class CustomSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def create_scheduler(
        ...
        # if self.data_args.ul2_nepochs == -1:
        ...
        # num_selfplay_steps = num_update_steps_per_epoch * self.data_args.ul2_nepochs

        # create_custom_scheduler(self.args, num_selfplay_steps, optimizer)
        # return super().create_scheduler(num_selfplay_steps, optimizer)
