...
def _encode_pairwise_example(
    ...
    prefix_length = source_len + 1 # account for <SEP> token which is in the output but counted as part of the prefix

    return chosen_input_ids, chosen_labels, rejected_input_ids, rejected_labels, prefix_length
...
def preprocess_pairwise_dataset(
    ...
    for i in range(len(examples["prompt"])):
        ...
        chosen_input_ids, chosen_labels, rejected_input_ids, rejected_labels, prefix_length = _encode_pairwise_example(
        ...
        model_inputs["prefix_lengths"].append(prefix_length)
