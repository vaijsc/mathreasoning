...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    # @QHP: add ul2 stage.
    stage: Literal["pt", "sft", "rm", "ppo", "dpo", "kto", "ul2", "ul2_dpo"] = field(
        default="sft",
        metadata={"help": "Which stage will be performed in training."},
    )
    
    ul2_finetune_embedding: bool = field(
        default=True, 
        metadata={"help": "whether or not to finetune the extended tokens"}
    )
    ...
    def __post_init__(self):
        ...
        # @QHP: add ul2_dpo
        self.use_ref_model = (self.stage == "dpo" or self.stage == "ul2_dpo") and self.pref_loss not in ["orpo", "simpo"]
