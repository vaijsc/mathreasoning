#!/bin/bash -e
#SBATCH --job-name=gen_mistral7b-sft-gsm8k-10epoch_checkpoint-1160_3_beamsearch_norethink
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --out_file infer_res/mistral7b-sft-gsm8k-10epoch_checkpoint-1160_gsm8k_test_beamsearch_3.json \
    --batch_size 1 \
    --causal_prefix \
    --sc none
