#!/bin/bash -e
#SBATCH --job-name=gen_deepseek-math-sft-gsm8k-masked-thought_checkpoint-928_0_beamsearch_norethink
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --out_file infer_res/deepseek-math-sft-gsm8k-masked-thought_checkpoint-928_gsm8k_test_beamsearch_0.json \
    --batch_size 1 \
    --causal_prefix \
    --sc none
