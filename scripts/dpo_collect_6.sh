#!/bin/bash -e
#SBATCH --job-name=gen_deepseek-math-ul2-gsm8k-septoken-maskfull-sentence-equation-lossfulltarget-5ep-bartmixed-singlemasktoken_checkpoint-580_dpo_cot_rethink_6
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --out_file infer_res/dpo_collect_cot/deepseek-math-ul2-gsm8k-septoken-maskfull-sentence-equation-lossfulltarget-5ep-bartmixed-singlemasktoken_checkpoint-580_gsm8k_train_dpo_cot_rethink_bartmixed0616_6.json \
    --batch_size 1 \
    --ul2 \
    --sc cot \
    --cot_mode "greedy" \
