#!/bin/bash -e
#SBATCH --job-name=gen_deepseek-math-ul2-gsm8k-septoken-maskfull-sentence-equation-lossfulltarget-5ep-bartmixed-singlemasktoken_checkpoint-580_cot_rethink_bartmixed0616_5
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --dataset_path cache/gsm8k_train_5.json \
    --out_file infer_res/deepseek-math-ul2-gsm8k-septoken-maskfull-sentence-equation-lossfulltarget-5ep-bartmixed-singlemasktoken_checkpoint-580_gsm8k_train_cot_rethink_bartmixed0616_review_scratch_5.json \
    --batch_size 1 \
    --ul2 \
    --sc cot \
    --cot_mode "greedy" \
