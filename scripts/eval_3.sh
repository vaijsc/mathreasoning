#!/bin/bash -e
#SBATCH --job-name=gen_deepseek-7b-ul2-gsm8k-t5-rerun-correctdata-finetune-lmhead-1e-4_checkpoint-928_beamsearch_ul2_3
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --out_file infer_res/deepseek-7b-ul2-gsm8k-t5-rerun-correctdata-finetune-lmhead-1e-4_checkpoint-928_gsm8k_test_beamsearch_ul2_3.json \
    --batch_size 1 \
    --ul2 \
    --sc none
