#!/bin/bash -e
#SBATCH --job-name=gen_deepseek-math-sft-gsm8k-10epoch_checkpoint-1160_1_beamsearch_norethink
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --out_file infer_res/base_model/deepseek-math-sft-gsm8k-10epoch_checkpoint-1160_gsm8k_test_beamsearch_1.json \
    --batch_size 1 \
    --causal_prefix \
    --sc none
