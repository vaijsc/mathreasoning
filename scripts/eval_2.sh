#!/bin/bash -e
#SBATCH --job-name=gen_deepseek-math-ul2-gsm8k-bi-no-mask_checkpoint-580_norethink_bartmixed_2
...
python LLaMA-Factory/src/utils/infer_ul2.py \
    ...
    --out_file infer_res/deepseek-math-ul2-gsm8k-bi-no-mask_checkpoint-580_gsm8k_test_norethink_2.json \
    --batch_size 1 \
    --ul2 \
    --sc cot \
    --cot_mode "greedy" \
